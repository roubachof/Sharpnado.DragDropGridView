...
/// <summary>
/// Extension methods for configuring Sharpnado.GridLayout in a MAUI application.
/// </summary>
public static class MauiAppBuilderExtensions
{
    /// <summary>
    /// Configures Sharpnado.GridLayout for the MAUI application.
    /// </summary>
    ...
    /// <param name="logFilter">Separate tags you want to filter with pipe operator (e.g., "GridLayout|Drag|Drop").</param>
    /// <returns>The MauiAppBuilder for chaining.</returns>
    public static MauiAppBuilder UseSharpnadoGridLayout(
